...
Entidades identificadas: users, profiles, project_stages, mentor_services, subscriptions, matches
Roles de usuario: public_user, VIP_subscriber, mentor_user, super_admin
Consultas más frecuentes: [DESCRIPCIÓN]
Volumen esperado: ~500 usuarios activos mensuales, 150 suscripciones VIP
