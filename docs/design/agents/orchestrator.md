...
Módulo nuevo a desarrollar: Motor de búsqueda con filtros públicos, formulario de perfilado por etapa de escalamiento y algoritmo de match proactivo para suscriptoras VIP
...
```text
Orquesta el desarrollo de: Motor de búsqueda con filtros públicos, formulario de perfilado por etapa de escalamiento y algoritmo de match proactivo para suscriptoras VIP

Proyecto: mentoras-vip / Stack: Next.js + Supabase + TypeScript
